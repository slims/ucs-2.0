 ...
 */
   ...
   *
	 ...
	 */
	function create_header($identifier,$timestamp,$ands_class, $add_to_node=null, $affiliation=null, $institution_id=null, $institution=null) {
    ...
    #if (!is_null($setName)) {
    #  $this->addChild($header_node,"setName",$setName); 
    #}
    if (!is_null($affiliation)) {
      $this->addChild($header_node,"affiliation", $affiliation);
    }
    if (!is_null($institution_id)) {
      $this->addChild($header_node,"institution_id", $institution_id);
    }
    if (!is_null($institution)) {
      $this->addChild($header_node,"setName",$institution); 
      $this->addChild($header_node,"institution", $institution);
    }
		return $header_node;
	}
